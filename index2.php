...
<head>
    ...
    <link rel="stylesheet" href="levelduo.css">
...
<body>
    ...
    <main>
        <div class="game-window">
            ...
            <div class="block" id="line-mid"></div>
            <div class="block" id="line-mid1"></div>

            <div class="block" id="line-mid2"></div>
            <div class="block" id="line-mid3"></div>

            <div id="draggableBlock" class="draggable-block"></div>
            <div id="door" class="door"></div>
            <div id="portal2" class="portal"></div>
            <div id="portal" class="portal-hid"></div>
